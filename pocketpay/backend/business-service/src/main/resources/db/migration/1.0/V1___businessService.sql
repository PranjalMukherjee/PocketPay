...
CREATE TABLE IF NOT EXISTS `pocketpay`.`business` (
  ...
  `registration_address` VARCHAR(145) NULL DEFAULT NULL,
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `pocketpay`.`bussiness_owners` (
  `id` INT NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_bussiness_owners_business1_idx` (`business_id` ASC) VISIBLE,
  CONSTRAINT `fk_bussiness_owners_business1`
