...
-- -----------------------------------------------------
-- Table `pocketpay`.`recipient`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `pocketpay`.`recipient` (
...
-- -----------------------------------------------------
-- Table `pocketpay`.`debit_card_payment`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `pocketpay`.`debit_card_payment` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `pocketpay`.`bank_payment`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `pocketpay`.`bank_payment` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `pocketpay`.`payment`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `pocketpay`.`payment` (
  `id` INT NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_payment_bank_payment1`
    ...
    REFERENCES `pocketpay`.`bank_payment` (`id`),
  CONSTRAINT `fk_payment_debit_card_payment1`
    FOREIGN KEY (`debit_card_payment_id`)
    REFERENCES `pocketpay`.`debit_card_payment` (`id`),
  CONSTRAINT `fk_payment_users1`
    FOREIGN KEY (`users_id`)
    REFERENCES `pocketpay`.`users` (`id`))
ENGINE = InnoDB
AUTO_INCREMENT = 2
DEFAULT CHARACTER SET = utf8mb3;
...
-- -----------------------------------------------------
-- Table `pocketpay`.`transactions`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `pocketpay`.`transactions` (
  `id` INT NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_transactions_payment1`
    ...
    REFERENCES `pocketpay`.`payment` (`id`),
  CONSTRAINT `fk_transactions_recipient1`
    FOREIGN KEY (`recipient_id`)
    REFERENCES `pocketpay`.`recipient` (`id`),
