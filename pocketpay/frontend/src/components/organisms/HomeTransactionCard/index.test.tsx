...
import { HomeTransaction } from './index';
import {
  AN_EXISTING_ACCOUNT,
...
const homeTransactionProps = {
  accounts: ['4656', '4252'],
  createdAt: new Date('Thu Sep 14 2023 21:32:42 GMT+0530 (India Standard Time)'),
...
describe('HomeTransaction', () => {
  test('renders the component correctly', () => {
    render(
      <HomeTransaction
        ...
        createdAt={new Date('Thu Sep 14 2023 06:32:42 GMT+0530 (India Standard Time)')}
      />
    );
  ...
  test('click on share button and open the modal', () => {
    render(
      <HomeTransaction
        {...homeTransactionProps}
        createdAt={new Date('Thu Sep 14 2023 12:32:42 GMT+0530 (India Standard Time)')}
      />
    );
