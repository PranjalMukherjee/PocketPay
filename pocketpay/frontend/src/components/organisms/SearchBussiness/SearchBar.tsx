...
const CustomTextField = styled(TextField)((props: { open?: boolean }) => ({
  ...
  '& .MuiOutlinedInput-root': {
    ...
    '&.Mui-focused fieldset': {
      ...
      borderBottom: props.open ? 'none' : `${theme.spacing(0.25)} solid ${theme.palette.grey[100]}`,
  ...
  return (
    <StyledBox>
      ...
      <div className="styleFooter">
        ...
        <span style={{ color: theme.palette.primary[500] }}>Enter your details</span>
      </div>
    </StyledBox>
  );
};
    ...
    <Autocomplete
      ...
      renderInput={(params) => (
        <CustomTextField
          ...
          InputProps={{
            ...params.InputProps,
            endAdornment: !listboxActive && <img src={search} alt="search icon" />
          }}
          open={listboxActive}
        />
      )}
